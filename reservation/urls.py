...
from reservation.views import (AboutRestoTemplateView, ContactsTemplateView,
                               ReservationCreateView, TableCreateView,
                               TableDeleteView, TableDetailView, TableListView,
                               TableTemplateView, TableUpdateView)
